        ...
        <div class="row-12 w-75">
            <div class="card card-primary card-outline" style="background-color: #f8c8dc; border-color: #f8c8dc;">
                <div class="card-header" style="background-color: #f8c8dc; border-color: #f8c8dc;">
                    <h5 class="m-0" style="color: black;">Update Data Daftar Minuman</h5>
                </div>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_minuman" value="<?= $data['nama_minuman'] ?>" style="background-color: #f8c8dc; color: black; border-color: #f8c8dc;">
                            </div>
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label" style="color: black;">Daerah Minuman</label>
                                <input type="text" class="form-control" name="daerah_minuman" value="<?= $data['daerah_minuman'] ?>" style="background-color: #f8c8dc; color: black; border-color: #f8c8dc;">
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <a class="btn btn-primary" href="?page=minuman" style="width: 6em; height: 2.4em;">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
